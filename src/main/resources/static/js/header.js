...
document.writeln("			<span id=\'logo\' style=\'float: left;margin-left: 10px;\'><img src=\'img/logo3.png\'/></span>");
...
document.writeln("			var ndate = years + \'-\' + month + \'-\' + days + \' \' + hours + \':\' + minutes + \':\' + seconds;");
