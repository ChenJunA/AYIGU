...
document.writeln("				margin: 60px auto;");
...
document.writeln("				<span>微博：陈俊啊丶</span>");
document.writeln("				<span>知乎：阿一古</span>");
document.writeln("				<span>GitHub：ChenJunA</span>");
document.writeln("			</div>");
document.writeln("			<div id=\'rightContent\'>");
document.writeln("				<div id=\'footIcon\'>");
document.writeln("					<img id=\'logo\' src=\'img/logo3.png\' />");
document.writeln("				</div>");
document.writeln("");
document.writeln("				<div id=\'copyright\'>");
document.writeln("					Copyright @ayigu,Design ayigu,2018-20xx");
document.writeln("				</div>");
document.writeln("			</div>");
